...
const ChallengesPage = () => {
  ...
  const pending = challenges.filter(
    (ch) =>
      ch.status === "pending" &&
      (ch.sender?.id === currentUser?.id || ch.receiver?.id === currentUser?.id)
  );
                                  ...
                                  <div className="flex gap-3 items-center">
                                    ...
                                    <div>
                                      ...
                                      {ch.match && typeof ch.match === "object" && (
                                        <>
                                          <p className="text-sm">
                                            Score: {ch.match.player1_score ?? "N/A"} - {ch.match.player2_score ?? "N/A"}
                                          </p>
                                          <p className="text-sm text-green-700 font-semibold">
                                            Winner: {typeof ch.match.winner_username === "string" ? ch.match.winner_username :  JSON.stringify(ch.match.winner_username)}
                                          </p>
                                        </>
                                      )}
                                    </div>
